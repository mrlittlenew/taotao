...
var category = {OBJ: $("#_JD_ALLSORT"),
		...
		URL_Serv: "http://rest.taotao.com:9091/rest/itemcat/list?callback=category.getDataService",
		//URL_Serv: "http://www.taotao.com:8082/category.json",
        ...
        return "" == c ? d : (/^http[s]?:\/\/([\w-]+\.)+[\w-]+([\w-.\/?%&=]*)?$/.test(c) || (c = c.replace(/-000$/, ""), c = c.match(/^\d*-\d*$/) ? "http://channel.jd.com/" + c + ".html" : "http://www.taotao.com:9092" + c + ".html"), '<a href="' + c + '">' + d + "</a>")
